...
export async function getMockToolparameter(
  ...
  return {
    params: [
      ...
      {
        desc: '线程数',
        desc_en: 'number of threads',
        key: 'CNV_seq_baozheng_Pipeline.threads',
        name: '线程数',
        name_en: 'threads',
        required: false,
        type: 'Int',
      ...
      {
        desc: '质控阈值',
        desc_en: 'quality threshold',
        key: 'CNV_seq_baozheng_Pipeline.quality_threshold',
        name: '质控阈值',
        name_en: 'quality threshold',
        required: false,
        type: 'Float',
        default: 0.05,
        visible: true,
      },
      {
        ...
        key: 'CNV_seq_baozheng_Pipeline.output_dir',
        name: '输出目录',
        name_en: 'output directory',
        required: true,
        type: 'Directory',
        visible: true,
      },
      {
        desc: '样本列表',
        desc_en: 'sample list',
        key: 'CNV_seq_baozheng_Pipeline.sample_list',
        name: '样本列表',
        name_en: 'sample list',
        required: false,
        type: 'Array[String]',
      ...
      {
        desc: '染色体编号',
        desc_en: 'chromosome numbers',
        key: 'CNV_seq_baozheng_Pipeline.chromosome_numbers',
        name: '染色体编号',
        name_en: 'chromosome numbers',
        required: false,
        type: 'Array[Int]',
        default: [1, 2, 3, 4, 5],
        visible: true,
      ...
      {
        desc: '是否启用质控',
        desc_en: 'enable quality control',
        key: 'CNV_seq_baozheng_Pipeline.enable_qc',
        name: '启用质控',
        name_en: 'enable QC',
        required: false,
        type: 'Boolean',
